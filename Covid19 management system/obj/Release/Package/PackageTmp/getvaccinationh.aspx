        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <table>
                    <tr>
                      <td>
                          <asp:RadioButton ID="RadioButton1" runat="server" Text="First Dose" GroupName="dose" />
                          <asp:RadioButton ID="RadioButton2" runat="server" Text="Second Dose" GroupName="dose"/>
                      </td>
                        <td>

                            <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Booking Number*" Width="239px"></asp:TextBox>

                        </td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="Button2" runat="server" class="btn btn-success" Text="Search" OnClick="Button2_Click" Width="76px" />
                        </td>
                    </tr>
                </table>
                <table>
