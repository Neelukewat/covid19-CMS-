        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <asp:BulletedList ID="BulletedList1" runat="server" Height="81px" Width="414px" CssClass="newStyle8">
                        <asp:ListItem Selected="True">Avoid Touching Your face.</asp:ListItem>
                        <asp:ListItem>Cover Your mouth and nose when Coughing.</asp:ListItem>
                ...
                <div class="col-sm-4">
                    ...
                    <br />
                    <br />
                    <asp:Image ID="Image2" runat="server" Width="334px" Height="347px" ImageUrl="~/img/OIP (3).jpg" class="float-right" />
