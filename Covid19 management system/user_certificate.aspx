...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section id="hero" class="d-flex align-items-center  noprint">
        <div class="container text-right position-relative">
            <asp:Label ID="Label1" runat="server" Text="Certificate" CssClass="accordion-body noprint" Font-Size="XX-Large" ForeColor="White" Font-Bold="True"></asp:Label>
            <br />
            <asp:Label ID="Label2" runat="server" Text="Prevent the spread stay at home,stay safe" CssClass="accordion-body noprint" Font-Size="Large" ForeColor="WhiteSmoke" Font-Bold="false"></asp:Label>
                    ...
                    <table class="w-100">
                        ...
                        <tr>
                            <td class="auto-style4">
                                <asp:TextBox ID="TextBox1" runat="server" class="form-control noprint" placeholder="Reference Id" Width="294px"></asp:TextBox>
                    ...
                    <table>
                        <tr>
                            <td>
                                <p class="auto-style2">
                                    <center>
                                        <asp:Label ID="Label5" Visible="false" runat="server" ForeColor="Red" CssClass="noprint" Text="label"></asp:Label>
                                    </center>
                                </p>
                            </td>
                        </tr>
