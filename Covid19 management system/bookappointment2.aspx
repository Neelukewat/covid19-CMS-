<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="bookappointment2.aspx.cs" Inherits="Covid19_management_system.bookappointment2" %>
                    ...
                    <center>
                        <form>
                                ...
                                <div class="col-sm-8 col-lg-8">
                                    <div class="form-group">
                                        <asp:DropDownList class="form-control" ID="DropDownList2" runat="server">
                                            ...
                                            <asp:ListItem Text="Jalandhar" Value="Jalandhar" />
                                        </asp:DropDownList>
                                    ...
                                    <div class="form-group">
                                        <asp:DropDownList class="form-control" ID="DropDownList3" runat="server">
                                            <asp:ListItem Text="Choose Center*" Value="select" />
                                              <asp:ListItem Text="Choose Center*" Value="select" />
                                        <asp:ListItem Text="CAMA Hospital " Value="xyzhospital" />
                                        <asp:ListItem Text="CSMT Platform 18 " Value="abchospital" />
                                        <asp:ListItem Text="City Hospital " Value="xyzhospital" />
                                        <asp:ListItem Text="Bhakti Hospital " Value="xyzhospital" />
                                        <asp:ListItem Text="JJ Hospital " Value="xyzhospital" />
                                        <asp:ListItem Text="Breach Candy Hospital " Value="xyzhospital" />
                                        <asp:ListItem Text="Wochard Hospital " Value="xyzhospital" />
                                        <asp:ListItem Text="Breach Candy Hospital " Value="xyzhospital" />
                                        <asp:ListItem Text="Siddharth Hospital " Value="xyzhospital" />
                                        <asp:ListItem Text="xyzcenter789" Value="xyzhospital" />

                                        <asp:ListItem Text="Sai Baba Hospital " Value="xyzhospital" />
                                        <asp:ListItem Text="Thunga Hospital " Value="xyzhospital" />
                                        </asp:DropDownList>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-8 col-lg-8">
                                    <div class="form-group">
                                        <asp:DropDownList class="form-control" ID="DropDownList4" runat="server" OnSelectedIndexChanged="DropDownList4_SelectedIndexChanged1" AutoPostBack="true">
                                            <asp:ListItem Text="Choose Vaccine*" Value="select" />
                                ...
                                <div class="col-sm-8 col-lg-8">
                                    <div class="form-group">
                                        <asp:DropDownList class="form-control" ID="DropDownList5" runat="server">
                                            <asp:ListItem Text="Choose Age*" Value="select" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-lg-8">
                                    <asp:TextBox ID="TextBox3" runat="server" class="form-control" ReadOnly="true" placeholder="Charges*" ></asp:TextBox>
                                </div>
                            </div>
                            <br />
                            <div class="form-group row justify-content-end">
                                <div class="col-sm-5">
                                    <br />
                                    <asp:Button class="btn btn-success btn-lg btn-danger" ID="Button1" runat="server" Text="Book Appointment" OnClick="Button1_Click1" />
